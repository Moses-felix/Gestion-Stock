...
class CrmDocumentController extends Controller
{
    ...
    public function index()
    {
        ...
        $crmDocuments = CrmDocument::with(['company', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.crmDocuments.create', compact('companies'));
    }
    ...
    public function edit(CrmDocument $crmDocument)
    {
        ...
        $crmDocument->load('company');

        return view('admin.crmDocuments.edit', compact('companies', 'crmDocument'));
    }
