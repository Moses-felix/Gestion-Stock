        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.rangement.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.rangements.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('nom_rangement') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nom_rangement" id="nom_rangement" value="{{ old('nom_rangement', '') }}" required>
