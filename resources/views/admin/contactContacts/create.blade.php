                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contact-contacts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('contact_first_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_first_name" id="contact_first_name" value="{{ old('contact_first_name', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('contact_last_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_last_name" id="contact_last_name" value="{{ old('contact_last_name', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('contact_phone_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_phone_1" id="contact_phone_1" value="{{ old('contact_phone_1', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('contact_email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_email" id="contact_email" value="{{ old('contact_email', '') }}" required>
