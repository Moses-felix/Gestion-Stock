                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contact-contacts.update", [$contactContact->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('company') ? 'has-error' : '' }}">
                            <label for="company_id">{{ trans('cruds.contactContact.fields.company') }}</label>
                        ...
                        <div class="form-group {{ $errors->has('contact_first_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_first_name" id="contact_first_name" value="{{ old('contact_first_name', $contactContact->contact_first_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('contact_last_name') ? 'has-error' : '' }}">
                            <label class="required" for="contact_last_name">{{ trans('cruds.contactContact.fields.contact_last_name') }}</label>
                            <input class="form-control" type="text" name="contact_last_name" id="contact_last_name" value="{{ old('contact_last_name', $contactContact->contact_last_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('contact_phone_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_phone_1" id="contact_phone_1" value="{{ old('contact_phone_1', $contactContact->contact_phone_1) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('contact_email') ? 'has-error' : '' }}">
                            <label class="required" for="contact_email">{{ trans('cruds.contactContact.fields.contact_email') }}</label>
                            <input class="form-control" type="text" name="contact_email" id="contact_email" value="{{ old('contact_email', $contactContact->contact_email) }}" required>
