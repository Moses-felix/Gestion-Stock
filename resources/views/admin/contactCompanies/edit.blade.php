                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contact-companies.update", [$contactCompany->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $contactCompany->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('prenom') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="prenom" id="prenom" value="{{ old('prenom', $contactCompany->prenom) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('telephone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="telephone" id="telephone" value="{{ old('telephone', $contactCompany->telephone) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('company_address') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="company_address" id="company_address" value="{{ old('company_address', $contactCompany->company_address) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $contactCompany->email) }}" required>
                            @if($errors->has('email'))
