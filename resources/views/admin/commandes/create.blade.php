                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.commandes.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('quantite') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="quantite" id="quantite" value="{{ old('quantite', '') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('transport') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="transport" id="transport" value="{{ old('transport', '0') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('divers') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="divers" id="divers" value="{{ old('divers', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('tva') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="tva_id" id="tva_id">
                                @foreach($tvas as $id => $entry)
                                    <option value="{{ $id }}" {{ old('tva_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('tva'))
                        ...
                        <div class="form-group {{ $errors->has('prix') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="prix" id="prix" value="{{ old('prix', '') }}" step="1" required>
                            @if($errors->has('prix'))
                        ...
                        <div class="form-group {{ $errors->has('delai_livraison') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="delai_livraison" id="delai_livraison" value="{{ old('delai_livraison') }}" required>
